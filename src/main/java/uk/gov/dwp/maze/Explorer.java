...
/**
 * This explorer can be dropped at the start point in the maze map. It runs a random route strategy to choose the next
 * available movement when there are multiple ones available at a particular location.
 *
 * Assumptions are made in the README file.
 */
